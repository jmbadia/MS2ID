...
## SECTION 1: Create RSQL database in disk file MS2ID.db keeping peakslit apart
##  with ffData
...
# on every row, startPos and numSpectra allows to find the IDReference spectra
# in the mzIndex_raw[ startPos(1:numSpectra) ].
lastPos <- 0
...
suppressWarnings(
    bigmemory::as.big.matrix(mzIndex_body, backingfile = "mzIndex_body.bin",
